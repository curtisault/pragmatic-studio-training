defmodule Servy.SensorServer do
  ...
  def start_link(interval) do
    IO.puts "Starting the sensor_server with #{interval} min refresh..."
    GenServer.start_link(__MODULE__, %{}, name: @processName)
  end

  def get_sensor_data do
    GenServer.call @processName, :get_sensor_data
  end
